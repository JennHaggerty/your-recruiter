...
import { ChatgptIcon } from '@/app/components/Icons/ChatgtpIcon';
import { VercelIcon } from '@/app/components/Icons/VercelIcon';
import { FlameIcon } from '@/app/components/Icons/FlameIcon';
  ...
  const renderJumbotron = () => (
    <div className='flex flex-col gap-3 justify-center mx-auto'>
      ...
      <div className='flex flex-col gap-5'>
        ...
        >
          <CardBody>
            <div className=' items-center justify-center mx-autoy'>
              <video controls autoPlay loop muted>
                <source src='./your-recruiter-demo.mp4' type='video/mp4' />
              ...
              >
                <div className='flex p-3 z-10 w-full justify-start items-center shrink-0 overflow-inherit color-inherit subpixel-antialiased rounded-t-large gap-2 pb-0'>
                  <div className='flex py-3 z-10 w-full justify-start items-center shrink-0 overflow-inherit color-inherit subpixel-antialiased rounded-t-large gap-2 pb-0'>
                    <div
                      className={`flex justify-center p-2 rounded-full items-center bg-${item.color}-100 text-${item.color}-500`}
                    >
                      {item.icon}
                    </div>
                    <p className='text-base font-semibold'>{item.title}</p>
